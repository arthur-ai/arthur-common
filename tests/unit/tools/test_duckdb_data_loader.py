...
from arthur_common.tools.duckdb_data_loader import escape_identifier, escape_str_literal, unescape_identifier
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('"struct_field.with.dots"."struct.nested.with.dots."', 'struct_field.with.dots.struct.nested.with.dots.'),
        ('"one"."two"."three"', 'one.two.three'),
        ('"column""with_escaped.quotes"', 'column"with_escaped.quotes'),
        ('"nestedColEscapedQuotes"""."nestedQuote""Here"', 'nestedColEscapedQuotes".nestedQuote"Here'),
        ('"on.""e"."two."""."""th.ree"', 'on."e.two."."th.ree'),
    ],

)
def test_unescape_identifier(col_name_escaped: str, col_name_expected_unescaped: str) -> None:
