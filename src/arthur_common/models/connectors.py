...
REST_CONNECTOR_BASE_URL_FIELD = "base_url"
REST_CONNECTOR_AUTHENTICATOR_FIELD = "authenticator"
REST_CONNECTOR_API_KEY_FIELD = "rest_api_key"
REST_CONNECTOR_API_KEY_HEADER_FIELD = "api_key_header"
REST_CONNECTOR_BEARER_TOKEN_FIELD = "bearer_token"
REST_CONNECTOR_OAUTH2_TOKEN_URL_FIELD = "oauth2_token_url"
REST_CONNECTOR_OAUTH2_CLIENT_ID_FIELD = "oauth2_client_id"
REST_CONNECTOR_OAUTH2_CLIENT_SECRET_FIELD = "oauth2_client_secret"
REST_CONNECTOR_OAUTH2_SCOPE_FIELD = "oauth2_scope"

# REST dataset locator fields
REST_DATASET_ENDPOINT_PATH_FIELD = "endpoint_path"
REST_DATASET_HTTP_METHOD_FIELD = "http_method"
REST_DATASET_START_TIME_PARAM_FIELD = "start_time_param"
REST_DATASET_END_TIME_PARAM_FIELD = "end_time_param"
REST_DATASET_START_TIME_FORMAT_FIELD = "start_time_format"
REST_DATASET_DATA_PATH_FIELD = "data_path"
REST_DATASET_PAGE_PARAM_FIELD = "page_param"
REST_DATASET_PAGE_SIZE_PARAM_FIELD = "page_size_param"
REST_DATASET_MAX_PAGES_FIELD = "max_pages"
